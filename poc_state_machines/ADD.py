...
states = [
    ...
    State("ADD_YRegVal_000", "1", "1", "R", "ADD_Inc_0001_GotoEndOfAcc"), # make these add the value we extracted to the accumulator register!
    State("ADD_YRegVal_001", "0", "0", "R", "ADD_Inc_0010_GotoEndOfAcc"), # make these add the value we extracted to the accumulator register!
    State("ADD_YRegVal_001", "1", "1", "R", "ADD_Inc_0011_GotoEndOfAcc"), # make these add the value we extracted to the accumulator register!
    State("ADD_YRegVal_01", "0", "0", "R", "ADD_YRegVal_010"),
    State("ADD_YRegVal_01", "1", "1", "R", "ADD_YRegVal_011"),
    State("ADD_YRegVal_010", "0", "0", "R", "ADD_Inc_0100_GotoEndOfAcc"), # make these add the value we extracted to the accumulator register!
    State("ADD_YRegVal_010", "1", "1", "R", "ADD_Inc_0101_GotoEndOfAcc"), # make these add the value we extracted to the accumulator register!
    State("ADD_YRegVal_011", "0", "0", "R", "ADD_Inc_0110_GotoEndOfAcc"), # make these add the value we extracted to the accumulator register!
    State("ADD_YRegVal_011", "1", "1", "R", "ADD_Inc_0111_GotoEndOfAcc"), # make these add the value we extracted to the accumulator register!
    ...
    State("ADD_YRegVal_100", "0", "0", "R", "ADD_Inc_1000_GotoEndOfAcc"), # make these add the value we extracted to the accumulator register!
    State("ADD_YRegVal_100", "1", "1", "R", "ADD_Inc_1001_GotoEndOfAcc"), # make these add the value we extracted to the accumulator register!
    State("ADD_YRegVal_101", "0", "0", "R", "ADD_Inc_1010_GotoEndOfAcc"), # make these add the value we extracted to the accumulator register!
    State("ADD_YRegVal_101", "1", "1", "R", "ADD_Inc_1011_GotoEndOfAcc"), # make these add the value we extracted to the accumulator register!
    State("ADD_YRegVal_11", "0", "0", "R", "ADD_YRegVal_110"),
    State("ADD_YRegVal_11", "1", "1", "R", "ADD_YRegVal_111"),
    State("ADD_YRegVal_110", "0", "0", "R", "ADD_Inc_1100_GotoEndOfAcc"), # make these add the value we extracted to the accumulator register!
    State("ADD_YRegVal_110", "1", "1", "R", "ADD_Inc_1101_GotoEndOfAcc"), # make these add the value we extracted to the accumulator register!
    State("ADD_YRegVal_111", "0", "0", "R", "ADD_Inc_1110_GotoEndOfAcc"), # make these add the value we extracted to the accumulator register!
    State("ADD_YRegVal_111", "1", "1", "R", "ADD_Inc_1111_GotoEndOfAcc"), # make these add the value we extracted to the accumulator register!
    
    # All the increments we need
    State("ADD_Inc_0001_GotoEndOfAcc", None, None, "R", "ADD_Inc_0001_GotoEndOfAcc"),
    State("ADD_Inc_0001_GotoEndOfAcc", "SP", "SP", "L", "ADD_Inc_0001"),
    State("ADD_Inc_0001", "A", "A", "R", "ADD_Finish"), # we dont go to ADD_Inc_0000 because then we'd inc one too many times, after this we're done
    State("ADD_Inc_0001", "0", "1", "L", "ADD_Finish"),
    State("ADD_Inc_0001", "1", "0", "L", "ADD_Inc_0001"),
    State("ADD_Inc_0010_GotoEndOfAcc", None, None, "R", "ADD_Inc_0010_GotoEndOfAcc"),
    State("ADD_Inc_0010_GotoEndOfAcc", "SP", "SP", "L", "ADD_Inc_0010"),
    State("ADD_Inc_0010", "A", "A", "R", "ADD_Inc_0001_GotoEndOfAcc"),
    State("ADD_Inc_0010", "0", "1", "L", "ADD_Inc_0001_GotoEndOfAcc"),
    State("ADD_Inc_0010", "1", "0", "L", "ADD_Inc_0010"),
    State("ADD_Inc_0011_GotoEndOfAcc", None, None, "R", "ADD_Inc_0011_GotoEndOfAcc"),
    State("ADD_Inc_0011_GotoEndOfAcc", "SP", "SP", "L", "ADD_Inc_0011"),
    State("ADD_Inc_0011", "A", "A", "R", "ADD_Inc_0010_GotoEndOfAcc"),
    State("ADD_Inc_0011", "0", "1", "L", "ADD_Inc_0010_GotoEndOfAcc"),
    State("ADD_Inc_0011", "1", "0", "L", "ADD_Inc_0011"),
    State("ADD_Inc_0100_GotoEndOfAcc", None, None, "R", "ADD_Inc_0100_GotoEndOfAcc"),
    State("ADD_Inc_0100_GotoEndOfAcc", "SP", "SP", "L", "ADD_Inc_0100"),
    State("ADD_Inc_0100", "A", "A", "R", "ADD_Inc_0011_GotoEndOfAcc"),
    State("ADD_Inc_0100", "0", "1", "L", "ADD_Inc_0011_GotoEndOfAcc"),
    State("ADD_Inc_0100", "1", "0", "L", "ADD_Inc_0100"),
    State("ADD_Inc_0101_GotoEndOfAcc", None, None, "R", "ADD_Inc_0101_GotoEndOfAcc"),
    State("ADD_Inc_0101_GotoEndOfAcc", "SP", "SP", "L", "ADD_Inc_0101"),
    State("ADD_Inc_0101", "A", "A", "R", "ADD_Inc_0100_GotoEndOfAcc"),
    State("ADD_Inc_0101", "0", "1", "L", "ADD_Inc_0100_GotoEndOfAcc"),
    State("ADD_Inc_0101", "1", "0", "L", "ADD_Inc_0101"),
    State("ADD_Inc_0110_GotoEndOfAcc", None, None, "R", "ADD_Inc_0110_GotoEndOfAcc"),
    State("ADD_Inc_0110_GotoEndOfAcc", "SP", "SP", "L", "ADD_Inc_0110"),
    State("ADD_Inc_0110", "A", "A", "R", "ADD_Inc_0101_GotoEndOfAcc"),
    State("ADD_Inc_0110", "0", "1", "L", "ADD_Inc_0101_GotoEndOfAcc"),
    State("ADD_Inc_0110", "1", "0", "L", "ADD_Inc_0110"),
    State("ADD_Inc_0111_GotoEndOfAcc", None, None, "R", "ADD_Inc_0111_GotoEndOfAcc"),
    State("ADD_Inc_0111_GotoEndOfAcc", "SP", "SP", "L", "ADD_Inc_0111"),
    State("ADD_Inc_0111", "A", "A", "R", "ADD_Inc_0110_GotoEndOfAcc"),
    State("ADD_Inc_0111", "0", "1", "L", "ADD_Inc_0110_GotoEndOfAcc"),
    State("ADD_Inc_0111", "1", "0", "L", "ADD_Inc_0111"),
    State("ADD_Inc_1000_GotoEndOfAcc", None, None, "R", "ADD_Inc_1000_GotoEndOfAcc"),
    State("ADD_Inc_1000_GotoEndOfAcc", "SP", "SP", "L", "ADD_Inc_1000"),
    State("ADD_Inc_1000", "A", "A", "R", "ADD_Inc_0111_GotoEndOfAcc"),
    State("ADD_Inc_1000", "0", "1", "L", "ADD_Inc_0111_GotoEndOfAcc"),
    State("ADD_Inc_1000", "1", "0", "L", "ADD_Inc_1000"),
    State("ADD_Inc_1001_GotoEndOfAcc", None, None, "R", "ADD_Inc_1001_GotoEndOfAcc"),
    State("ADD_Inc_1001_GotoEndOfAcc", "SP", "SP", "L", "ADD_Inc_1001"),
    State("ADD_Inc_1001", "A", "A", "R", "ADD_Inc_1000_GotoEndOfAcc"),
    State("ADD_Inc_1001", "0", "1", "L", "ADD_Inc_1000_GotoEndOfAcc"),
    State("ADD_Inc_1001", "1", "0", "L", "ADD_Inc_1001"),
    State("ADD_Inc_1010_GotoEndOfAcc", None, None, "R", "ADD_Inc_1010_GotoEndOfAcc"),
    State("ADD_Inc_1010_GotoEndOfAcc", "SP", "SP", "L", "ADD_Inc_1010"),
    State("ADD_Inc_1010", "A", "A", "R", "ADD_Inc_1001_GotoEndOfAcc"),
    State("ADD_Inc_1010", "0", "1", "L", "ADD_Inc_1001_GotoEndOfAcc"),
    State("ADD_Inc_1010", "1", "0", "L", "ADD_Inc_1010"),
    State("ADD_Inc_1011_GotoEndOfAcc", None, None, "R", "ADD_Inc_1011_GotoEndOfAcc"),
    State("ADD_Inc_1011_GotoEndOfAcc", "SP", "SP", "L", "ADD_Inc_1011"),
    State("ADD_Inc_1011", "A", "A", "R", "ADD_Inc_1010_GotoEndOfAcc"),
    State("ADD_Inc_1011", "0", "1", "L", "ADD_Inc_1010_GotoEndOfAcc"),
    State("ADD_Inc_1011", "1", "0", "L", "ADD_Inc_1011"),
    State("ADD_Inc_1100_GotoEndOfAcc", None, None, "R", "ADD_Inc_1100_GotoEndOfAcc"),
    State("ADD_Inc_1100_GotoEndOfAcc", "SP", "SP", "L", "ADD_Inc_1100"),
    State("ADD_Inc_1100", "A", "A", "R", "ADD_Inc_1011_GotoEndOfAcc"),
    State("ADD_Inc_1100", "0", "1", "L", "ADD_Inc_1011_GotoEndOfAcc"),
    State("ADD_Inc_1100", "1", "0", "L", "ADD_Inc_1100"),
    State("ADD_Inc_1101_GotoEndOfAcc", None, None, "R", "ADD_Inc_1101_GotoEndOfAcc"),
    State("ADD_Inc_1101_GotoEndOfAcc", "SP", "SP", "L", "ADD_Inc_1101"),
    State("ADD_Inc_1101", "A", "A", "R", "ADD_Inc_1100_GotoEndOfAcc"),
    State("ADD_Inc_1101", "0", "1", "L", "ADD_Inc_1100_GotoEndOfAcc"),
    State("ADD_Inc_1101", "1", "0", "L", "ADD_Inc_1101"),
    State("ADD_Inc_1110_GotoEndOfAcc", None, None, "R", "ADD_Inc_1110_GotoEndOfAcc"),
    State("ADD_Inc_1110_GotoEndOfAcc", "SP", "SP", "L", "ADD_Inc_1110"),
    State("ADD_Inc_1110", "A", "A", "R", "ADD_Inc_1101_GotoEndOfAcc"),
    State("ADD_Inc_1110", "0", "1", "L", "ADD_Inc_1101_GotoEndOfAcc"),
    State("ADD_Inc_1110", "1", "0", "L", "ADD_Inc_1110"),
    State("ADD_Inc_1111_GotoEndOfAcc", None, None, "R", "ADD_Inc_1111_GotoEndOfAcc"),
    State("ADD_Inc_1111_GotoEndOfAcc", "SP", "SP", "L", "ADD_Inc_1111"),
    State("ADD_Inc_1111", "A", "A", "R", "ADD_Inc_1110_GotoEndOfAcc"),
    State("ADD_Inc_1111", "0", "1", "L", "ADD_Inc_1110_GotoEndOfAcc"),
...
# todo: Fix the add instruction. the memory layout is PC 00000000 SP 000 X 0000 Y 0000 ACC 0000 ... so the SP is behind the acc marker not after T-T
...
def createStates(name="", binary=""):
    ...
    # States to increment the accumulator register
        # These two go right until we hit the stack pointer, then left once so we're on the last digit of the accumulator register
    moveRightToSP = State(currentStateName + "_GotoEndOfAcc", None, None, "R", currentStateName + "_GotoEndOfAcc")
    hitSPGoLeft = State(currentStateName + "_GotoEndOfAcc", "SP", "SP", "L", currentStateName)
    ...
    readZeroNextInc = State(currentStateName, "0", "1", "L", name + binaryMinusOne) # if read a zero, write a one and move on to the next increment
    ...
    outStates.extend([moveRightToSP, hitSPGoLeft, accumulatorOverflowFailsafe, readZeroNextInc, readOneKeepGoing])
